...
ALTER TABLE account ALTER COLUMN id SET DATA TYPE integer;
ALTER TABLE maintainer
  ALTER COLUMN id SET DATA TYPE integer,
  ALTER COLUMN organisation SET DATA TYPE integer,
  ALTER COLUMN account SET DATA TYPE integer;
ALTER TABLE entity ALTER COLUMN organisation SET DATA TYPE integer;
ALTER TABLE organisation ALTER COLUMN id SET DATA TYPE integer;
ALTER TABLE maintenance_event ALTER COLUMN id SET DATA TYPE integer;
ALTER TABLE maintenance_request ALTER COLUMN created_by SET DATA TYPE integer;
ALTER TABLE organisation_invite ALTER COLUMN organisation SET DATA TYPE integer;
ALTER TABLE template ALTER COLUMN organisation SET DATA TYPE integer;
ALTER TABLE organisation_account
  ALTER COLUMN account SET DATA TYPE integer,
  ALTER COLUMN organisation SET DATA TYPE integer,
  ALTER COLUMN account_role SET DATA TYPE integer;
ALTER TABLE maintenance_task
  ALTER COLUMN maintenance_event SET DATA TYPE integer,
  ALTER COLUMN maintainer SET DATA TYPE integer;
ALTER TABLE maintainer_entity
  ALTER COLUMN maintainer SET DATA TYPE integer,
  ALTER COLUMN organisation SET DATA TYPE integer;
ALTER TABLE refresh_token ALTER COLUMN account_id SET DATA TYPE integer;
