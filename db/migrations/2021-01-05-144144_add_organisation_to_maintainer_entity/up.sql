ALTER TABLE entity ADD CONSTRAINT entity_organisation_key UNIQUE (uuid, organisation);
...
ALTER TABLE maintainer_entity ADD COLUMN organisation integer NOT NULL,
  ...
  ADD CONSTRAINT maintainer_entity_entity_fkey FOREIGN KEY (entity, organisation) REFERENCES entity (uuid, organisation),
